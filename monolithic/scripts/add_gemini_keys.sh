#!/bin/bash
# Script to seed Gemini API keys from keys.txt file
...
# Path to keys file
KEYS_FILE="/home/uzzalh/Workplace/github/uzzalhcse/Crawlify/keys.txt"
